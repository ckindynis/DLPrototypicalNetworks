...
def run_experiment(
    ...
    num_classes_train: int = typer.Option(5, help="Number of classes to use in an episode while training."),
    num_support_train: int = typer.Option(5, help="Number of support points to use in an episode while training."),
    num_query_train: int = typer.Option(5, help="Number of query points to use in an episode while training."),
    num_classes_val: int = typer.Option(5, help="Number of classes to use in an episode during validation."),
    num_support_val: int = typer.Option(5, help="Number of support points to use in an episode during validation."),
    num_query_val: int = typer.Option(5, help="Number of query points to use in an episode during validation."),
